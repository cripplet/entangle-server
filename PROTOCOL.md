...
A response can be generated by the server spontaneously WITHOUT prompting by the client. In this case, `MSG_ID` is set to `0`.
...
server, upon receiving response-2, will update its internal client data buffer to match that of the client.
