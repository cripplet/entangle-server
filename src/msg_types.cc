...
entangle::EntangleMessageResponse::EntangleMessageResponse(size_t msg_id, std::string client_id, std::string cmd, size_t err, std::string arg) : entangle::EntangleMessage(true, msg_id, client_id, "", cmd, err, std::vector<std::string> { arg }, "") {};
...
entangle::EntangleMessageResizeRequest::EntangleMessageResizeRequest(size_t msg_id, std::string client_id, std::string auth, size_t buffer_size) : entangle::EntangleMessage(false, msg_id, client_id, auth, entangle::EntangleMessage::cmd_resize, entangle::EntangleMessage::error_no_err, std::vector<std::string> { std::to_string(buffer_size) }) {}
