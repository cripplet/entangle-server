...
TEST_CASE("entangle|msg_types-conn") {
	auto req = entangle::EntangleMessageConnectRequest(182, "pw", "localhost", 9099, "server-pw");
	REQUIRE(req.to_string().compare("0:182::pw:CONN:0:localhost:9099:server-pw") == 0);
